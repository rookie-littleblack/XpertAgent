...
from xpertagent.protos import xocr_pb2 as xocr__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in xocr_pb2_grpc.py depends on'
...
def add_XOCRServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'xpertagent.protos.XOCRService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('xpertagent.protos.XOCRService', rpc_method_handlers)
