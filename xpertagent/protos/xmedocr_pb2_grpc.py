...
from xpertagent.protos import xmedocr_pb2 as xmedocr__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in xmedocr_pb2_grpc.py depends on'
...
def add_XMedOCRServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'xpertagent.protos.XMedOCRService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('xpertagent.protos.XMedOCRService', rpc_method_handlers)
